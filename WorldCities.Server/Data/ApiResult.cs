...
public class ApiResult<T>
{
    ...
    /// <returns>
    /// An object containing the paged result and all the relevant paging navigation info.
    /// </returns>
    ...
    /// <param name="throwExceptionIfNotFound">Whether or not to throw an exception if property name not found</param>
    /// <returns>Boolean indicating property valid or not</returns>
